...
const PLATFORMS: PlatformInfo[] = [
  {
    ...
    Icon: Instagram,
    href: "/api/connect/meta/start?next=/onboarding?step=3",
  },
  {
    platform: "TIKTOK",
    label: "TikTok",
    Icon: Music2,
    href: "/api/connect/tiktok/start?next=/onboarding?step=3",
  },
  {
    platform: "YOUTUBE",
    label: "YouTube",
    Icon: Youtube,
    href: "/api/connect/youtube/start?next=/onboarding?step=3",
  },
  {
    platform: "SPOTIFY",
    label: "Spotify (input manuale)",
    Icon: Music,
    href: "/impostazioni/spotify?next=/onboarding?step=3",
